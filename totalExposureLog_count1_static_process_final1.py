        ...
        for item1 in product_id_list:
            if "," in str1:
                ...
                for  item in str_list:
                    if "," in material_size:
                        material_size_list=material_size.split(",")
                        for material_size1 in material_size_list:
                            index+=1
                            res=str(index)+","+line_list[0]+","+line_list[1]+","+material_size1+","+item+","+line_list[4]+","+item1+","+line_list[6]+","+line_list[7]+","+line_list[8]+"\n"
                            # print("res")
                            # print(line_list)
                            # print(res)
                            file_res.write(res)
                        ...
                        index += 1
                        res = str(index) + "," + line_list[0] + "," + line_list[
                            1] + "," + material_size + "," + item + "," + line_list[4] + "," + item1 + "," + line_list[
                                  6] + "," + line_list[7] + "," + line_list[8] + "\n"
                        # print("res")
                        # print(line_list)
                        # print(res)
                        file_res.write(res)
                ...
                if "," in material_size:
                    ...
                    for material_size1 in material_size_list:
                        index += 1
                        res = str(index)+","+line_list[0]+","+line_list[1]+","+material_size1+","+str1+","+line_list[4]+","+item1+","+line_list[6]+","+line_list[7]+","+line_list[8]+"\n"
                        # print("res")
                        # print(line_list)
                        # print(res)
                        file_res.write(res)
                    ...
                    index += 1
                    res=str(index)+","+line_list[0]+","+line_list[1]+","+material_size+","+str1+","+line_list[4]+","+item1+","+line_list[6]+","+line_list[7]+","+line_list[8]+"\n"
                    file_res.write(res)
    else:
        if "," in str1:
            str_list = str1.split(",")
            for item in str_list:
                if "," in material_size:
                    ...
                    for material_size1 in material_size_list:
                        index += 1
                        res = str(index) + "," + line_list[0] + "," + line_list[1] + "," +material_size1 + "," + item + "," + \
                              line_list[4] + "," + product_id + "," + line_list[6] + "," + line_list[7] + "," + \
                              line_list[8] + "\n"
